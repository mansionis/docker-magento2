...
# Install packages
RUN apk --no-cache add supervisor curl git nginx php7 php7-cli php7-fpm php7-phar php7-json 

#RUN apk --no-cache add php7-mysqli php7-openssl php7-curl \
#    php7-zlib php7-xml php7-intl php7-dom php7-xmlreader php7-ctype php7-session \
#    php7-mbstring php7-gd php7-bcmath php7-iconv
